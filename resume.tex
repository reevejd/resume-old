...
%%% Essentials
\name{James}{Reeve}
\address{33 Kingsmount N, Hamilton, Ontario (Willing to Relocate)}
\mobile{\quad 416-999-6168} 
%%% Social
\email{\quad reevejamesd@gmail.com}
\homepage{\quad jamesreeve.ca}
\github{\quad reevejd}
\linkedin{\quad reevejamesd}
%%% Optionals
...
\import{\sectiondir}{additionalexperienceandawards.tex}
